...
hyperparameters = {
    'halfcheetah-random-v2':         {'lr': 3e-4, 'eta': 4.0,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 9.0,  'top_k': 1},
    'hopper-random-v2':              {'lr': 3e-4, 'eta': 4.0,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 9.0,  'top_k': 2},
    'walker2d-random-v2':            {'lr': 3e-4, 'eta': 0.5,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 1.0,  'top_k': 1},
    ...
    'walker2d-medium-v2':            {'lr': 3e-4, 'eta': 0.5,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 1.0,  'top_k': 1},
    'halfcheetah-medium-replay-v2':  {'lr': 3e-4, 'eta': 1.0,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 2.0,  'top_k': 0},
    'hopper-medium-replay-v2':       {'lr': 3e-4, 'eta': 1.0,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 4.0,  'top_k': 2},
    'walker2d-medium-replay-v2':     {'lr': 3e-4, 'eta': 0.5,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 4.0,  'top_k': 1},
    'halfcheetah-medium-expert-v2':  {'lr': 3e-4, 'eta': 1.0,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 7.0,  'top_k': 0},
    'hopper-medium-expert-v2':       {'lr': 3e-4, 'eta': 1.0,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 5.0,  'top_k': 2},
    'walker2d-medium-expert-v2':     {'lr': 3e-4, 'eta': 0.5,   'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 50, 'num_epochs': 1000, 'gn': 5.0,  'top_k': 1},
...
def train_agent(env, state_dim, action_dim, max_action, device, output_dir, args):
    ...
    if args.algo == 'ql':
        from agents.ql_diffusion_c import Diffusion_QL_C as Agent
        agent = Agent(
    ...
    while (training_iters < max_timesteps) and (not early_stop):
        iterations = int(10 * args.num_steps_per_epoch)
        print('args.num_epochs', args.num_epochs)
        print('args.eval_freq',args.eval_freq)
        print('args.num_steps_per_epoch',args.num_steps_per_epoch)
...
def eval_policy(policy, env_name, seed, eval_episodes=10):
    ...
    avg_norm_score=avg_norm_score*100.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--state_n", default=5, type=int)
